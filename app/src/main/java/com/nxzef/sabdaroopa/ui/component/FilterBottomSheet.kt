...
fun FilterBottomSheet(
    ...
    val labelLanguage = userPreferences.labelLanguage
    ...
    ModalBottomSheet(
        ...
        Column(
            ...
            FilterSection(
                ...
                when (labelLanguage) {
                    LabelLanguage.English -> category.toPascalCase()
                    LabelLanguage.Sanskrit -> stringResource(category.skt)
                }
            }
            ...
            FilterSection(
                ...
                when (labelLanguage) {
                    LabelLanguage.English -> sound.toPascalCase()
                    LabelLanguage.Sanskrit -> stringResource(sound.skt)
                }
            }
            ...
            FilterSection(
                ...
                when (labelLanguage) {
                    LabelLanguage.English -> gender.toPascalCase()
                    LabelLanguage.Sanskrit -> stringResource(gender.skt)
                }
            }
