...
import com.nxzef.sabdaroopa.ui.LocalExtendedColorScheme
...
object ExtendedMaterialTheme {
    private val extendedColors
        @Composable get() = LocalExtendedColorScheme.current

    val success: ColorFamily
        @Composable get() = extendedColors.success

    val wrong: ColorFamily
        @Composable get() = extendedColors.wrong

    val colorScheme: ExtendedColorScheme
        @Composable get() = extendedColors
}
